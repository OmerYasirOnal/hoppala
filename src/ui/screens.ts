...
const STRINGS = {
  tr: {
    ...
    settings: 'Ayarlar', sound: 'Ses', music: 'Müzik', haptics: 'Titreşim', language: 'Dil', system: 'Sistem', nickname: 'Takma ad',
  ...
  en: {
    ...
    settings: 'Settings', sound: 'Sound', music: 'Music', haptics: 'Haptics', language: 'Language', system: 'System', nickname: 'Nickname',
